// Initial setup of list of cities and API key

var cityList = [];
var id = "3064a3ce490432cc3c54376ccfea04bb";

// Stores the list of cities the user entered into localStorage
...
if (uv < 3) {
    document.getElementById().attr("style", "background-color:#00CACD");
  } else if (uv < 5) {
    document.getElementById().attr("style", "background-color:#008F00");
  } else if (uv < 7) {
    document.getElementById().attr("style", "background-color:#CD5600");
  } else if (uv < 10) {
    document.getElementById().attr("style", "background-color:#D01E00");
  } else {
    document.getElementById().attr("style", "background-color:#E361B4");
  }
